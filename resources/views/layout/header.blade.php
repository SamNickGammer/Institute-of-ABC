...
<div
    ...
    <div class="px-[25px] md:px-[75px] h-[84px] justify-between items-center flex">
        <div class="1000:flex gap-[25px] hidden">
            <a href="{{route('home')}}" class="h-[84px] flex items-center text-[18px] {{ Route::currentRouteName() == 'home' ? 'font-HellixSB border-b-4 border-ThemeBlack' : 'font-HellixR text-[#1B1B1B]'}}">Home</a>
            <a href="{{route('about')}}" class="h-[84px] flex items-center text-[18px] {{ Route::currentRouteName() == 'about' ? 'font-HellixSB border-b-4 border-ThemeBlack' : 'font-HellixR text-[#1B1B1B]'}}">About Us</a>
            <a href="{{route('course')}}" class="h-[84px] flex items-center text-[18px] {{ Route::currentRouteName() == 'course' ? 'font-HellixSB border-b-4 border-ThemeBlack' : 'font-HellixR text-[#1B1B1B]'}}">Course</a>
            <a href="{{route('gallery')}}" class="h-[84px] flex items-center text-[18px] {{ Route::currentRouteName() == 'gallery' ? 'font-HellixSB border-b-4 border-ThemeBlack' : 'font-HellixR text-[#1B1B1B]'}}">Gallery</a>
        </div>
        ...
        <div class="1000:flex gap-[25px] hidden">
            <div class="relative inline-block group/dropdown">
                ...
                <div class="hidden absolute bg-gray-100 min-w-[200px] shadow-lg z-10 group-hover/dropdown:block top-[70px] rounded-[10px]">
                  <a href="{{route('student_info')}}" class="block px-4 py-2 text-black hover:bg-gray-300 no-underline hover:rounded-t-[10px] font-HellixR transition-all hover:px-[1.25rem] text-[15px]">Student Information</a>
...
<div id="mobile-menu" class="fixed inset-0 bg-white backdrop-blur-lg bg-opacity-80 z-50 transform -translate-x-full transition-transform duration-500 ease-in-out">
    <div class="flex flex-col justify-center items-center h-screen relative">
        ...
        <a href="{{route('home')}}" class="text-[18px] mb-6 font-HellixSB">Home</a>
        <a href="{{route('about')}}" class="text-[18px] mb-6 font-HellixSB">About Us</a>
        <a href="{{route('course')}}" class="text-[18px] mb-6 font-HellixSB">Course</a>
        <a href="{{route('gallery')}}" class="text-[18px] mb-6 font-HellixSB">Gallery</a>
        ...
        <div class="">
            ...
            <div id="accordion-content" class="flex flex-col items-center overflow-hidden transition-all duration-500 max-h-0">
                <a href="{{route('student_info')}}" class="text-[16px] mb-4 font-HellixR">Student Information</a>
